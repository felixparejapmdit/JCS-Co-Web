...
import { Department, LeaveRequest, AttendanceRecord, Employee201 } from '../domain/entities/HRIS';
...
export class TenantDataStore {
  ...
  public employees201: Map<string, Employee201[]> = new Map();
    ...
    for (const r of roles) {
      ...
      for (const m of modules) {
        ...
        if (isAdmin) {
          ...
          view = ['payroll_hris', 'hris', 'payroll'].includes(m);
          insert = ['payroll_hris', 'hris', 'payroll'].includes(m);
          edit = ['payroll_hris', 'hris', 'payroll'].includes(m);
          del = ['payroll_hris', 'hris', 'payroll'].includes(m);
          approve = ['hris'].includes(m);
        }
  ...
  public seedTenant(tid: string): void {
    ...
    // 10. Comprehensive HRIS 201 Records
    const emps201: Employee201[] = [
      new Employee201({
        id: `${tid}-emp-01`,
        tenantId: tid,
        employeeCode: `EMP-${tid}-001`,
        ...
        address: 'Blk 12 Lot 4, Greenfield Heights, Dasmariñas, Cavite',
        emergencyContactName: 'Clara Dela Cruz (Spouse)',
        emergencyContactPhone: '+63 917 999 1122',
        position: 'Senior Chemical Engineer',
        department: 'Plant Operations',
        costCenterCode: 'CC-PLANT',
        employmentStatus: 'REGULAR',
        hireDate: '2021-03-15',
        regularizationDate: '2021-09-15',
        monthlyBasicSalary: 45000,
        dailyRate: 1730.77,
        hourlyRate: 216.35,
        allowanceMonthly: 3500,
        tin: '123-456-789-000',
        sssNumber: '03-1234567-8',
        philHealthNumber: '12-345678901-2',
        pagIbigNumber: '1234-5678-9012',
      ...
      new Employee201({
        ...
        address: 'Unit 4B, Solenad Residences, Santa Rosa, Laguna',
        emergencyContactName: 'Eduardo Santos (Spouse)',
        emergencyContactPhone: '+63 918 888 2233',
        position: 'Plant Operations Manager',
        department: 'Plant Operations',
        costCenterCode: 'CC-PLANT',
        employmentStatus: 'REGULAR',
        hireDate: '2019-06-01',
        regularizationDate: '2019-12-01',
        monthlyBasicSalary: 75000,
        dailyRate: 2884.62,
        hourlyRate: 360.58,
        allowanceMonthly: 6000,
        tin: '234-567-890-000',
        sssNumber: '03-9876543-2',
        philHealthNumber: '12-987654321-0',
        pagIbigNumber: '2345-6789-0123',
        bankName: 'Bank of the Philippine Islands (BPI)',
        bankAccountNumber: '0023-4567-8901',
      ...
      new Employee201({
        ...
        address: '142 San Vicente St., Biñan, Laguna',
        emergencyContactName: 'Luz Reyes (Mother)',
        emergencyContactPhone: '+63 920 777 3344',
        position: 'Materials & Warehouse Lead',
        department: 'Materials Management',
        costCenterCode: 'CC-MAT',
        employmentStatus: 'REGULAR',
        hireDate: '2022-11-10',
        regularizationDate: '2023-05-10',
        monthlyBasicSalary: 32000,
        dailyRate: 1230.77,
        hourlyRate: 153.85,
        allowanceMonthly: 2000,
        tin: '345-678-901-000',
        sssNumber: '03-4567890-1',
        philHealthNumber: '12-456789012-3',
        pagIbigNumber: '3456-7890-1234',
        bankName: 'Metrobank',
        bankAccountNumber: '0034-5678-9012',
        vacationLeaveCredits: 10,
        sickLeaveCredits: 8,
        emergencyLeaveCredits: 3,
      }),
      new Employee201({
        ...
        address: '77 Narra St., Carmona, Cavite',
        emergencyContactName: 'Ramon Gomez (Father)',
        emergencyContactPhone: '+63 922 666 4455',
        position: 'Treasury & Cashier Specialist',
        department: 'Finance & Treasury',
        costCenterCode: 'CC-FIN',
        employmentStatus: 'REGULAR',
        hireDate: '2023-02-20',
        regularizationDate: '2023-08-20',
        monthlyBasicSalary: 28000,
        dailyRate: 1076.92,
        hourlyRate: 134.62,
        allowanceMonthly: 1500,
        tin: '456-789-012-000',
        sssNumber: '03-6789012-3',
        philHealthNumber: '12-678901234-5',
        pagIbigNumber: '4567-8901-2345',
        bankName: 'Security Bank',
        bankAccountNumber: '0045-6789-0123',
        vacationLeaveCredits: 8,
        sickLeaveCredits: 7,
        emergencyLeaveCredits: 3,
      }),
      new Employee201({
        ...
        address: '35 Mahogany Lane, Alabang, Muntinlupa City',
        emergencyContactName: 'Mark Lim (Spouse)',
        emergencyContactPhone: '+63 927 555 6677',
        position: 'HR & People Operations Lead',
        department: 'Human Resources',
        costCenterCode: 'CC-HR',
        employmentStatus: 'REGULAR',
        hireDate: '2020-08-15',
        regularizationDate: '2021-02-15',
        monthlyBasicSalary: 38000,
        dailyRate: 1461.54,
        hourlyRate: 182.69,
        ...
        pagIbigNumber: '5678-9012-3456',
        bankName: 'BDO Unibank',
        bankAccountNumber: '0056-7890-1234',
        vacationLeaveCredits: 14,
        sickLeaveCredits: 10,
        emergencyLeaveCredits: 4,
      }),
      new Employee201({
        id: `${tid}-emp-06`,
        tenantId: tid,
        ...
        civilStatus: 'MARRIED',
        email: 'rtan@jcs.ph',
        phone: '+63 928 678 9012',
        address: '88 Diamond St., BF Homes, Parañaque City',
        emergencyContactName: 'Grace Tan (Spouse)',
        emergencyContactPhone: '+63 928 444 7788',
        position: 'Internal Audit & Compliance Officer',
        department: 'Finance & Treasury',
        costCenterCode: 'CC-FIN',
        employmentStatus: 'REGULAR',
        hireDate: '2021-01-10',
        regularizationDate: '2021-07-10',
        monthlyBasicSalary: 42000,
        dailyRate: 1615.38,
        hourlyRate: 201.92,
        allowanceMonthly: 3000,
        tin: '678-901-234-000',
        sssNumber: '03-8901234-5',
        philHealthNumber: '12-890123456-7',
        pagIbigNumber: '6789-0123-4567',
        bankName: 'BPI',
        bankAccountNumber: '0067-8901-2345',
        vacationLeaveCredits: 11,
        sickLeaveCredits: 9,
        emergencyLeaveCredits: 3,
      }),
    ];
    this.employees201.set(tid, emps201);
    ...
    const depts: Department[] = [
      ...
      },
      {
        ...
        tenantId: tid,
        code: 'DEPT-OPS',
        name: 'Plant Operations & Engineering',
        managerName: 'Maria Santos, ChE',
        budgetMonthly: 420000,
        headcount: 8,
        costCenterCode: 'CC-PLANT',
      },
      {
      ...
      },
      {
        ...
        managerName: 'Teresa Lim',
        budgetMonthly: 110000,
        headcount: 2,
        costCenterCode: 'CC-HR',
      },
    ];
    this.departments.set(tid, depts);

    // 12. HRIS Leave Requests
    const leaves: LeaveRequest[] = [
      {
        id: `${tid}-lv-001`,
        tenantId: tid,
        employeeId: `${tid}-emp-01`,
        employeeCode: `EMP-${tid}-001`,
        ...
        endDate: '2026-09-26',
        daysCount: 2,
        reason: 'Family out of town vacation',
        status: 'PENDING',
        appliedAt: '2026-09-20T08:30:00Z',
      },
      {
        id: `${tid}-lv-002`,
        tenantId: tid,
        employeeId: `${tid}-emp-04`,
        employeeCode: `EMP-${tid}-004`,
        employeeName: 'Gomez, Elena T.',
        department: 'Finance & Treasury',
        leaveType: 'SICK',
        ...
        status: 'APPROVED',
        appliedAt: '2026-09-17T14:15:00Z',
        reviewedBy: 'Teresa Lim (HR)',
      ...
      },
      {
        id: `${tid}-lv-003`,
        tenantId: tid,
        employeeId: `${tid}-emp-03`,
        employeeCode: `EMP-${tid}-003`,
        employeeName: 'Reyes, Carlos M.',
        department: 'Materials Management',
        leaveType: 'EMERGENCY',
        startDate: '2026-09-10',
        endDate: '2026-09-10',
        daysCount: 1,
        reason: 'House plumbing repair emergency',
        status: 'APPROVED',
        appliedAt: '2026-09-09T19:00:00Z',
        reviewedBy: 'Teresa Lim (HR)',
        reviewedAt: '2026-09-10T07:45:00Z',
      },
    ];
    this.leaveRequests.set(tid, leaves);

    // 13. HRIS Attendance Records
    const attendance: AttendanceRecord[] = [
      ...
      },
      {
        id: `${tid}-att-002`,
        tenantId: tid,
        employeeId: `${tid}-emp-02`,
        employeeCode: `EMP-${tid}-002`,
        employeeName: 'Santos, Maria G.',
        department: 'Plant Operations',
        date: '2026-09-21',
        timeIn: '07:50 AM',
        timeOut: '06:30 PM',
      ...
      },
      {
        id: `${tid}-att-005`,
        tenantId: tid,
        employeeId: `${tid}-emp-05`,
        employeeCode: `EMP-${tid}-005`,
        employeeName: 'Lim, Teresa V.',
        department: 'Human Resources',
        date: '2026-09-21',
        timeIn: '07:48 AM',
        timeOut: '05:15 PM',
      ...
      },
      {
        id: `${tid}-att-006`,
        tenantId: tid,
        employeeId: `${tid}-emp-06`,
        employeeCode: `EMP-${tid}-006`,
        employeeName: 'Tan, Roberto C.',
        department: 'Finance & Treasury',
        date: '2026-09-21',
        timeIn: '08:00 AM',
        timeOut: '05:00 PM',
    ...
    this.attendanceRecords.set(tid, attendance);
